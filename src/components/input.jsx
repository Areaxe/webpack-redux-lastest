...
class Input extends React.Component {
  ...
  dataValidate(text) {  //策略模式
    let {minLength,maxLength,require,errorText={}} = this.props;
  ...
  render() {
    let { value,showClose,searchResult,showSearchResult,error } = this.state;
    let { name, className, children, type = "text", onFocus, onBlur, autoComplete, placeholder, 
    defaultValue, disabled,autoCapitalize,onEnter,autoSearch=true,errorText,
  } = this.props;
    ...
    return <div className={classnames('input-container', { [className]: className })} >
      <div className="input-main">
        ...
        <input
          ref="input"
          className={classnames("com-input",{"search-input":isSearch})}
